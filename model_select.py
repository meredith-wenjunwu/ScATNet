...
def main():
    ...
    for checkpoint_dir in checkpoint_dirs:
        ...
        best_file, model_fnames = generate_average_checkpts(epoch_numbers, checkpoint_dir, args.after_ep)
        compare_test_checkpoints(args.load_config, model_fnames, checkpoint_dir)
