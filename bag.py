...
class Bag:
    ...
    def __init__(self, img, label=None, size=3600, overlap_pixel=2400):
        ...
        self.length = (self.h-self.overlap_pixel)/(self.size-self.overlap_pixel) * (self.w-self.overlap_pixel)/(self.size-self.overlap_pixel)
        self.label = label
    ...
    def __len__(self):
        ...
        """
        return (self.h-self.overlap_pixel)/(self.size-self.overlap_pixel) * (self.w-self.overlap_pixel)/(self.size-self.overlap_pixel)
